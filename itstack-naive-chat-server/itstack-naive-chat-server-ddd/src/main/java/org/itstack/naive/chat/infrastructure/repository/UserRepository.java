...
import org.itstack.naive.chat.infrastructure.dao.IChatRecordDao;
import org.itstack.naive.chat.infrastructure.dao.IGroupsDao;
import org.itstack.naive.chat.infrastructure.dao.ITalkBoxDao;
import org.itstack.naive.chat.infrastructure.dao.IUserDao;
import org.itstack.naive.chat.infrastructure.dao.IUserFriendDao;
import org.itstack.naive.chat.infrastructure.dao.IUserGroupDao;
...
public class UserRepository implements IUserRepository {
  ...
  @Autowired private IChatRecordDao chatRecordDao;
  @Autowired private IGroupsDao groupsDao;
  @Autowired private ITalkBoxDao talkBoxDao;
  @Autowired private IUserDao userDao;
  @Autowired private IUserFriendDao userFriendDao;
  @Autowired private IUserGroupDao userGroupDao;
  ...
  public List<LuckUserInfo> queryFuzzyUserInfoList(String userId, String searchKey) {
    ...
    for (User user : userList) {
      LuckUserInfo userInfo =
          new LuckUserInfo(user.getUserId(), user.getUserNickName(), user.getUserHead(), 0);
