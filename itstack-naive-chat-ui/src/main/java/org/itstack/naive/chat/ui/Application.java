...
public class Application extends javafx.application.Application {
  ...
  public void start(Stage primaryStage) throws Exception {
    ...
    chat.addTalkMsgGroupLeft(
        "5307397", "1000002", "拎包冲", "01_50", "推我过忘川", 0, new Date(), true, false, true);
    chat.addTalkMsgGroupLeft(
        "5307397", "1000003", "铁锤", "03_50", "奈河桥边的姑娘", 0, new Date(), true, false, true);
    chat.addTalkMsgGroupLeft(
        "5307397", "1000004", "哈尼克兔", "04_50", "等我回头看", 0, new Date(), true, false, true);
    chat.addTalkMsgGroupLeft(
        "5307397", "1000004", "哈尼克兔", "04_50", "f_25", 1, new Date(), true, false, true);
